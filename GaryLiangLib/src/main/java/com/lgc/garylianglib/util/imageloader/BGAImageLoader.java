...
public abstract class BGAImageLoader {
    ...
    public abstract void display(ImageView imageView, String path, @DrawableRes int loadingResId, @DrawableRes int failResId, DisplayDelegate delegate);
     ...
     * @param delegate
     */
    public abstract void displayCircle(ImageView imageView, String path, @DrawableRes int loadingResId, @DrawableRes int failResId, DisplayDelegate delegate);
